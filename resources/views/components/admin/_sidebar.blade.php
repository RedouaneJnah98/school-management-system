    ...
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item">
                ...
                <div
                    class="multi-level collapse {{ request()->routeIs('admin.attendances.index', 'admin.branches.index', 'admin.classrooms.index', 'admin.routines.index', 'admin.groups.index', 'admin
                    .subjects.index') ? 'show' : '' }}"
                    role="list"
