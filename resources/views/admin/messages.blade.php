<x-dashboard_layout>
    ...
    <div class="d-flex justify-content-between align-items-center pb-2 pt-4 pb-md-4">
        <div><a href="./single-message.html" class="btn btn-secondary d-inline-flex align-items-center mb-3 mb-md-0">
        ...
        <div class="d-block d-sm-flex">
            ...
            <div class="mb-3 mb-md-0">
                <button type="button" class="btn btn-gray-800 d-inline-flex alignpitems-center dropdown-toggle arrow-none" data-bs-toggle="dropdown" aria-expanded="false">More
                ...
                <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1" style=""><a class="dropdown-item d-flex align-items-center" href="#">
                        ...
                        Mark as read </a><a class="dropdown-item d-flex align-items-center" href="#">
                        <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="message-wrapper border-0 bg-white shadow rounded mb-">
        <div class="row">
            <div class="col-12">
                <!-- Tab -->
                <nav>
                    <div class="nav nav-tabs mb-4" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-home-tab" data-bs-toggle="tab" href="#nav-parents" role="tab" aria-controls="nav-parents" aria-selected="true">Parents</a>
                        <a class="nav-item nav-link" id="nav-profile-tab" data-bs-toggle="tab" href="#nav-students" role="tab" aria-controls="nav-students" aria-selected="false">Students</a>
                    </div>
                </nav>
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-parents" role="tabpanel" aria-labelledby="nav-parents-tab">
                                    ...
                                    <div class="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
                                        ...
                                        <div class="col-10 col-lg-2 ps-0 ps-lg-3 pe-lg-3">
                                            <a href="#" class="d-flex align-items-center">
                                                <img src="{{ asset('storage/avatars/' . $parent->profile_image) }}" class="avatar-sm rounded-circle me-3" alt="Parent Avatar">
                                        ...
                                        <div class="col-12 col-lg-7 d-flex align-items-center mt-3 mt-lg-0 ps-0">
                                            <a href="./single-message.html" class="fw-normal text-gray-600-900 truncate-text">
                                                {{--                                                <span class="fw-bold ps-lg-5">Long time no see - Can we help you set up email forwarding?</span>--}}
                            ...
                            @foreach($message->students as $student)
                                <div class="card hover-state border-bottom rounded-0 rounded-top py-3">
                                    <div class="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
                                        ...
                                        <div class="col-10 col-lg-2 ps-0 ps-lg-3 pe-lg-3">
                                            <a href="#" class="d-flex align-items-center">
                                                <img src="{{ asset('storage/avatars/' . $student->profile_image) }}" class="avatar-sm rounded-circle me-3" alt="Parent Avatar">
