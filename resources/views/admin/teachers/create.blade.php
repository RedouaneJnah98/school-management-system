                    ...
                    <form action="{{ route('admin.teachers.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-4 col-sm-6 mb-4">
                                ...
                                <label class="cities" for="cities">City</label>
                                <select class="form-select select-city" id="cities" name="city">
                                    {{--                                    <option selected class="city">Open this select menu</option>--}}
