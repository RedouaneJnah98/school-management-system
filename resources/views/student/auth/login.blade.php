                ...
                <div class="row">
                    <div class="col-sm-6 text-black px-5 mt-5">
                        ...
                        <div class="d-flex align-items-center h-custom-2 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                            ...
                            <form action="{{ route('student.check') }}" method="post" style="width: 500px;">
                                @csrf

                                <div class="mb-4">
                                    <h3 class="fw-bold text-primary">Sign In</h3>
                                    <small class="text-gray-500">This is space is reserved only for student, enter your email address and password to access your account. </small>
                                </div>
                                ...
                                <div class="d-flex justify-content-between gap-4">
                                    ...
                                    <div class="form-outline col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <a href="{{ route('student.password.request') }}" class="form-text text-muted link-primary small">Forgot password?</a>
                                            </div>
                                        </div>
                    ...
                    <div class="col-sm-6 px-0 d-none d-sm-block">
                        <img src="{{ asset('assets/img/pages/student-login.jpg') }}"
