                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div>
                                ...
                                <input class="form-control" disabled value="{{ $parent->firstname }}">
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div>
                                <label>Last Name</label>
                                <input class="form-control" disabled value="{{ $parent->lastname }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div>
                                ...
                                <input class="form-control" disabled value="{{ $parent->date_of_birth }}">
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div>
                                <label>Gender</label>
                                <input class="form-control" disabled value="{{ ucwords($parent->gender) }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div>
                                <label>Email</label>
                                <input class="form-control" disabled value="{{ $parent->email }}">
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div>
                                <label>Phone</label>
                                <input class="form-control" disabled value="{{ $parent->phone_number }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-9 mb-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="address" value="{{ $parent->address }}" disabled>
                            </div>
                        </div>
                        <div class="col-sm-3 mb-3">
                            <div class="form-group">
                                <label for="number">Number</label>
                                <input class="form-control" id="number" value="{{ $parent->number }}" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-4 mb-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="city" value="{{ $parent->city }}" disabled>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="zip">ZIP</label>
                                <input class="form-control" id="zip" value="{{ $parent->zip }}" disabled>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <div class="col-12 mb-4">
                    <div class="card shadow border-0 text-center p-0">
                        ...
                        <div class="card-body pb-5">
                            <img src="{{ Storage::url($parent->profile_image) }}" class="avatar-xl rounded-circle mx-auto mt-n7 mb-4" alt="Neil Portrait">
                    ...
                    <div class="card card-body border-0 shadow mb-4">
                        ...
                        @foreach($parent->children as $child)
                            <div class="d-flex align-items-center">
                                <div class="me-3">
                                    <!-- Avatar -->
                                    <img class="rounded avatar-xl" src="{{ Storage::url($child->profile_image) }}" alt="change avatar">
                                </div>
