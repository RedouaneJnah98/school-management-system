                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div>
                                    ...
                                    <input class="form-control" disabled value="{{ $teacher->firstname }}">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div>
                                    <label>Last Name</label>
                                    <input class="form-control" disabled value="{{ $teacher->lastname }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div>
                                    ...
                                    <input class="form-control" disabled value="{{ $teacher->dob }}">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div>
                                    <label>Gender</label>
                                    <input class="form-control" disabled value="{{ ucwords($teacher->gender) }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div>
                                    <label>Email</label>
                                    <input class="form-control" disabled value="{{ $teacher->email }}">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div>
                                    <label>Phone</label>
                                    <input class="form-control" disabled value="{{ $teacher->phone }}">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 mb-4">
                        <div class="card shadow border-0 text-center p-0">
                            ...
                            <div class="card-body pb-5">
                                <img src="{{ $teacher->profile_image }}" class="avatar-xl rounded-circle mx-auto mt-n7 mb-4" alt="Neil Portrait">
                                <h4 class="h3">{{ $teacher->firstname . ' ' . $teacher->lastname }}</h4>
                                <h5 class="fw-normal">{{ $teacher->profile_bio }}</h5>
                                <p class="text-gray mb-4">{{ $teacher->city }}</p>
