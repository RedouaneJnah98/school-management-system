<x-dashboard_layout>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">All Ajiale School Students</h2>
            <p class="mb-0">This list contains the best Students in the world.</p>
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ route('admin.students.create') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
            ...
            <div class="btn-group ms-2 ms-lg-3">
                <a href="{{ route('admin.download_students') }}" class="btn btn-sm btn-outline-gray-600">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table user-table table-hover align-items-center">
                    ...
                    @foreach($students as $student)
                        <tr>
                            ...
                            <td>
                                @php
                                    $last_seen = $student->last_login_date;
                                @endphp
                ...
                <div class="card-footer px-3 border-0 d-flex flex-column flex-lg-row align-items-center justify-content-between">
                    {{ $students->links() }}
                    <div class="fw-normal small mt-4 mt-lg-0">Showing <b>{{ $students->firstItem() }}</b> to <b>{{ $students->lastItem() }}</b> of <b>{{ $students->total() }}</b> entries</div>
                </div>
            </div>
        </div>
    </div>
