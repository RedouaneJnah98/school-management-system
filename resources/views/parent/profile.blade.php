<x-dashboard_layout>
    ...
    <!-- Form -->
    <form action="{{ route('parent.update', auth()->user()->id) }}" method="post" enctype="multipart/form-data">
        @method('PUT')
        @csrf
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control @error('date_of_birth') is-invalid @enderror" name="date_of_birth" id="birthday" type="date"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" id="phone" type="text" value="{{ auth()->user()->phone_number }}">
                                    @error('phone_number')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
