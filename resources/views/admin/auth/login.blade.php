                            ...
                            <form action="{{ route('admin.check') }}" method="post" class="mt-4">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="teacher@gmail.com"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex justify-content-between align-items-top mb-4">
                                        ...
                                        <div><a href="{{ route('admin.password.request') }}" class="small text-right">Lost password?</a></div>
                                    </div>
                                </div>
                                <div class="d-grid">
