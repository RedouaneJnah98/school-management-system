                ...
                <div class="row">
                    <div class="col-12 text-center d-flex align-items-center justify-content-center">
                        <div>
                            ...
                            <p class="lead my-4">Oops! Looks like you followed a bad link.</p>
                            <a href="{{ route('admin.dashboard') }}" class="btn btn-gray-800 d-inline-flex align-items-center justify-content-center mb-4">
