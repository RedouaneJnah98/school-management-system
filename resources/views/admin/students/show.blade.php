            ...
            <div class="col-12 col-xl-8">
                <div class="card card-body border-0 shadow mb-4">
                    ...
                    <form>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div>
                                    ...
                                    <input class="form-control" disabled value="{{ $student->firstname }}">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div>
                                    <label>Last Name</label>
                                    <input class="form-control" disabled value="{{ $student->lastname }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div>
                                    ...
                                    <input class="form-control" disabled value="{{ $student->date_of_birth }}">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div>
                                    <label>Gender</label>
                                    <input class="form-control" disabled value="{{ ucwords($student->gender) }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div>
                                    <label>Email</label>
                                    <input class="form-control" disabled value="{{ $student->email }}">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div>
                                    <label>Phone</label>
                                    <input class="form-control" disabled value="{{ $student->phone }}">
                                </div>
                            </div>
                        </div>
                        ...
                        {{--                                    <input class="form-control" id="address" value="{{ $teacher->address }}" disabled>--}}
                        {{--                                </div>--}}
                        {{--                            </div>--}}
                        {{--                            <div class="col-sm-3 mb-3">--}}
                        {{--                                <div class="form-group">--}}
                        {{--                                    <label for="number">Number</label>--}}
                        {{--                                    <input class="form-control" id="number" value="{{ $teacher->number }}" disabled>--}}
                        {{--                                </div>--}}
                        {{--                            </div>--}}
                        {{--                        </div>--}}
                        {{--                        <div class="row">--}}
                        ...
                        {{--                                    <input class="form-control" id="city" value="{{ $teacher->city }}" disabled>--}}
                        {{--                                </div>--}}
                        {{--                            </div>--}}
                        {{--                            <div class="col-sm-4">--}}
                        {{--                                <div class="form-group">--}}
                        {{--                                    <label for="zip">ZIP</label>--}}
                        {{--                                    <input class="form-control" id="zip" value="{{ $teacher->zip }}" disabled>--}}
                        {{--                                </div>--}}
                        {{--                            </div>--}}
                        {{--                            <div class="col-sm-4 mb-3">--}}
                        {{--                                <label for="status">Status</label>--}}
                        {{--                                <input class="form-control" id="status" value="{{ ucwords($teacher->status) }}" disabled>--}}
                        {{--                            </div>--}}
                        {{--                        </div>--}}
                    </form>
                </div>
                    ...
                    <div class="col-12 mb-4">
                        <div class="card shadow border-0 text-center p-0">
                            ...
                            <div class="card-body pb-5">
                                <img src="{{ $student->profile_image }}" class="avatar-xl rounded-circle mx-auto mt-n7 mb-4" alt="Neil Portrait">
                                <h4 class="h3">{{ $student->firstname . ' ' . $student->lastname }}</h4>
                                <h5 class="fw-normal">Cool Student.</h5>
                                <p class="text-gray mb-4">Tanger</p>
