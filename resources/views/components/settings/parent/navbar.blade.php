            ...
            <ul class="navbar-nav align-items-center">
                ...
                <li class="nav-item dropdown ms-lg-3">
                    ...
                    <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('parent.settings') }}">
                            <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor" viewBox="0 0 20 20"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('parent.support') }}">
                            <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor" viewBox="0 0 20 20"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('parent.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                        ...
                        <form action="{{ route('parent.logout') }}" method="post" id="logout-form">@csrf</form>
                    </div>
                </li>
            </ul>
        </div>
