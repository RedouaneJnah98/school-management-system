        ...
        <nav id="navbar-main" aria-label="Primary navigation" class="navbar navbar-main navbar-expand-lg navbar-theme-primary pt-4 navbar-dark">
            <div class="container position-relative">
                    ...
                    <div class="navbar-collapse-header">
                        <div class="row">
                            ...
                            <div class="col-6 collapse-close">
                                <a href="#navbar_global" class="fas fa-times" data-toggle="collapse" data-target="#navbar_global" aria-controls="navbar_global" aria-expanded="false" title="close"
                ...
                <div class="d-flex align-items-center ms-auto">
                    <a href="{{ route('teacher.login') }}" class="btn btn-outline-white d-inline-flex align-items-center me-md-3">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="bootstrap-big-icon d-none d-lg-block">
                            <svg xmlns="http://www.w3.org/2000/svg" width="700" height="622" class="d-block my-1" viewBox="0 0 118 94" role="img"><title>Bootstrap</title>
                        ...
                        <h1 class="fw-bolder">Ajiale School Application Management</h1>
