            ...
            <ul class="navbar-nav align-items-center">
                ...
                <li class="nav-item dropdown ms-lg-3">
                       ...
                       aria-expanded="false">
                        <div class="media d-flex align-items-center">
                            <img class="avatar rounded-circle" alt="Image placeholder"
                                 src="{{ Storage::url(auth('teacher')->user()->profile_image) }}" style="object-fit: cover;object-position: top"/>
                            <div class="media-body ms-2 text-dark align-items-center d-none d-lg-block">
                                <span class="mb-0 font-small fw-bold text-gray-900">{{ auth('teacher')->user()->fullName }}</span>
                            </div>
                        </div>
                    </a>
                    <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('teacher.settings') }}">
                            <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor" viewBox="0 0 20 20"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('teacher.support') }}">
                            <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor" viewBox="0 0 20 20"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('teacher.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                        ...
                        <form action="{{ route('teacher.logout') }}" method="post" id="logout-form">@csrf</form>
                    </div>
                </li>
            </ul>
        </div>
